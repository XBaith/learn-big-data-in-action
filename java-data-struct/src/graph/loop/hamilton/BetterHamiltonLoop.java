...
public class BetterHamiltonLoop {
    private Graph graph;
    private int vs;
    private int[] pre;
    private int end = -1;
    ...
    public static void main(String[] args) {
        ...
        BetterHamiltonLoop simpleHm = new BetterHamiltonLoop(simpleGraph);
        System.out.println(simpleHm.path());

        Graph hmGraph = new Graph("input/hamilton.txt");
        BetterHamiltonLoop hamiltonLoop = new BetterHamiltonLoop(hmGraph);
